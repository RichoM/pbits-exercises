...
var G__22319 = cljs.core.first(element_str);
switch (G__22319) {
case "?":
arr.push((1));
...
var G__22336 = cljs.core.next(items);
items = G__22336;
continue;
} else {
return null;
...
var G__22337 = cljs.core.next(items);
items = G__22337;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__22331 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__22331) : is_valid_QMARK_.call(null,G__22331));
})())){
var G__22339 = cljs.core.next(cljs.core.next(items));
items = G__22339;
continue;
} else {
return true;
...
switch (G__22334) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__22332_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22332_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__22333_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22333_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22334)].join('')));
