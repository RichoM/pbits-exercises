...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11579 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11579(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11581 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11581(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11583 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11583(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11587 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11587(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11599 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11599(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11601 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11601(reader);
}
});
...
var G__11724 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11725 = s.append(c);
c = G__11724;
s = G__11725;
continue;
}
