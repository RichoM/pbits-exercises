...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15696 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15696(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_15698 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_15698(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_15706 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_15706(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_15708 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_15708(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15711 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15711(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15715 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15715(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__15678,callback){
var map__15680 = p__15678;
var map__15680__$1 = cljs.core.__destructure_map(map__15680);
var input = map__15680__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15680__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15680__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
