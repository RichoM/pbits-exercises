...
var and__5043__auto____$1 = (!(oops.helpers.is_prototype_QMARK_(f)));
...
var G__22119 = cljs.core.next(items);
items = G__22119;
continue;
} else {
return arr;
...
var x21990 = error;
(x21990.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x21990.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__22125 = Object.getPrototypeOf(o);
o = G__22125;
continue;
} else {
...
var or__5045__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5808__auto__ = (goog.global["devtools"]);
